...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Slide 1 to Slide 3 (which is now index 1 after removing slide-2)
  ...
  if (slide3NextBtn) {
    slide3NextBtn.addEventListener('click', function() {
      if (validateSlide3()) {
        showSlideAnimated(2); // Slide 4 is index 2 (0-based, after removing slide-2)
      }
    });
  }

  // Back button: go to Slide 1
  if (slide3BackBtn) {
    slide3BackBtn.addEventListener('click', function() {
      showSlideAnimated(0); // Slide 1 is index 0 (0-based)
    });
  }
  ...
  if (slide4NextBtn) {
    slide4NextBtn.addEventListener('click', function() {
      if (validateSlide4()) {
        showSlideAnimated(3); // Slide 5 is index 3 (0-based, after removing slide-2)
      }
    });
  }
  ...
  if (slide4BackBtn) {
    slide4BackBtn.addEventListener('click', function() {
      showSlideAnimated(1); // Slide 3 is index 1 (0-based, after removing slide-2)
    });
  }
  ...
  if (slide5NextBtn) {
    slide5NextBtn.addEventListener('click', function() {
      if (validateSlide5()) {
        showSlideAnimated(4); // Slide 6 is index 4 (0-based, after removing slide-2)
      }
    });
  }
  ...
  if (slide6NextBtn) {
    ...
    slide6NextBtn.addEventListener('click', function() {
      if (validateSlide6()) {
        showSlideAnimated(5); // Slide 7 is index 5 (0-based, after removing slide-2)
      }
    });
  }
  ...
  if (slide7NextBtn) {
    ...
    slide7NextBtn.addEventListener('click', function() {
      if (validateSlide7()) {
        showSlideAnimated(6); // Slide 8 is index 6 (0-based, after removing slide-2)
      }
    });
  }
